...
Public Methods, Constructors and Constants For Each Class:
  ...
  - Deck:
     ...
     - static final Color[] colors = {Color.RED, Color.BLUE, Color.GREEN, Color.YELLOW}; ❌ Make this public please.
     - void shuffle() ✅
  ...
  - Hand:
     - Non-Stub Classes in Hand: 
        ...
        - void setVisibility(boolean v) ❌ As you should realize, a new private variable goes with this
  ...
  - UnoGUI:
     - UnoGUI() ❌ if UnoGUI extends JFrame, then super("Title"); this also makes paint(g) easier to use
     - static final double CARD_CONVERSION_FACTOR = 3/2; ❌ This stuff helps with the Card's and Hand's render() functions
     - static final int CARD_HEIGHT = (int) 68 * CARD_CONVERSION_FACTOR; ❌
	   - static final int CARD_WIDTH = (int) 44 * CARD_CONVERSION_FACTOR; ❌
